  ...
  missing_patterns="$(
    {
      ...
      git -C "$ROOT_DIR" grep -q 'jarvis bringup-summary ~/Desktop/jarvis-bringup-evidence' -- docs-site/index.html || echo "docs-site/index.html missing bring-up summary command"
